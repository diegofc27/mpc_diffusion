...
def evaluate(**deps):
    ...
    # for i in range(num_eval):
    #     images[i].append(env.render()[i])
    # myImg = env.render()
    # #save as png
    # import pdb; pdb.set_trace()
    #save as img
    #myImg.save("/home/fernandi/projects/decision-diffuser/code/images/myImg.png")
    #myImg.show()
    #save as gif
    ...
    while not done:
        ...
        # for i in range(num_eval):
        #     images[i].append(env.render()[i])
        #apped image in batch dimension
        #images.append(env.render(mode='rgb_array')[None])
        print("")
        # print("action: ",action[i])
    ...
    print(f"FINAL Sucess rate:{success_rate}/{num_eval}")
    # for i in range(num_eval):
    #     write_apng(f"/home/fernandi/projects/decision-diffuser/code/images/diff_push_parallel{Config.seed}_{i}.png", images[i], delay=40) 
    #     Image(filename=f"/home/fernandi/projects/decision-diffuser/code/images/diff_push_parallel{Config.seed}_{i}.png")
